      ...
      <div class="mb-5">
        <div class="flex justify-between">
          <div class="space-x-0 sm:space-x-2">
            ...
            <div class="inline-flex h-10 items-center gap-2 rounded-md p-2" v-if="props.showFilters">
              <Button
                @click="addFilter"
                variant="outline"
                size="icon-sm"
        ...
        <!-- Generovana filtrace -->
        <div v-if="props.showFilters" class="mb-2 mt-2 flex flex-wrap gap-x-2">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <Select v-model="itemsPerPage">
            ...
            <SelectContent>
              <SelectGroup>
                <SelectItem v-bind="table.paginator.pageSize" v-for="size in pageSizes" :key="size"
                  :value="String(size)"
                >
                {{ size }}
                </SelectItem>
